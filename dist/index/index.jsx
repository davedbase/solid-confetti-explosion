...
export const ConfettiExplosion = inProps => {
    ...
    return (<Show when={isVisible() && isValid()}>
      <div class={`sce-container${props.class ? ` ${props.class}` : ""}`} style={{ "--floor-height": `${props.stageHeight}px` }}>
        <For each={particles()}>
          {particle => (<div class="sce-particle" use:confettiStyles={{ ...particle, ...props }}>
